 ...
 * @since 0.26.0
 */
public class StringSignerOnly {
    private final SignerOnly signer;

    public StringSignerOnly(final PrivateKey privateKey) {
        signer = new SignerOnly(privateKey);
    }


    public StringSignerOnly(final SignerOnly signer) {
        this.signer = signer;
    }
